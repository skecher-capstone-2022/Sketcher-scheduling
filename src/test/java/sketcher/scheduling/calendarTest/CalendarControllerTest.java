...
public class CalendarControllerTest {
    ...
    @Autowired
    ScheduleUpdateReqService scheduleUpdateReqService;
    ...
    public void deleteEvent() throws Exception {
        ...
        ManagerAssignScheduleDto managerAssignScheduleDto = ManagerAssignScheduleDto.builder()
                ...
                .build();
        Integer scheduleId = managerAssignScheduleService.saveManagerAssignSchedule(managerAssignScheduleDto);
        managerAssignScheduleService.deleteById(scheduleId);
        // then
        assertThat(managerAssignScheduleService.findById(scheduleId)).isEmpty();
