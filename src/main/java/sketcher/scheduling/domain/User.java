...
//    @Pattern(regexp = "[a-zA-Z0-9]*")
     ...
     */
    @Builder
    public User(String id, String authRole, String password, String username, String userTel, LocalDateTime user_joinDate, Double managerScore, Character dropoutReqCheck) {
